...
(function ($) {
    ...
    function back_to_top() {
        ...
        if (typeof ScrollSmoother !== 'undefined' && ScrollSmoother.get()) {
            ScrollTrigger.addEventListener('scroll', toggleBackToTop);
        } else {
            windowOn.on('scroll', toggleBackToTop);
        }
    ...
    //                 return `
    //                 <span class="char" aria-hidden="true" style="--char:${i + 1}">
    //                     <span class="char-inner">
    //                         <span class="char-top">${safeChar}</span>
    //                         <span class="char-bottom">${safeChar}</span>
    //                     </span>
    //                 </span>`;
    //             })
    //             .join('');
